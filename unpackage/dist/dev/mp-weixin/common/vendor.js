...
refreshToken() {return _refreshToken.apply(this, arguments);}function _refreshToken() {_refreshToken = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var e, _ref2, data, d, c, _e, b;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (!
            ...
            setStorage('userInfo', b.data.UserInfo);case 27:case "end":return _context2.stop();}}}, _callee2, this);}));return _refreshToken.apply(this, arguments);}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.myWorkFace = myWorkFace;exports.myWorkPhoto = myWorkPhoto;exports.myWorkPhotoLocation = myWorkPhotoLocation;exports.photoSubmit = photoSubmit;var _http = __webpack_require__(/*! @/config/http.js */ 19);
...
//加载积分商品
function myWorkFace(data) {
  return (0, _http.request)({
    method: 'GET',
    url: _api.MYWORK_FACE,
    showSuccessToast: true,
    data: data });

}
//加载拍照任务
function myWorkPhoto(data) {
  return (0, _http.request)({
    method: 'GET',
    url: _api.MYWORKPHOTO,
    showSuccessToast: true,
    data: data });

}
//加载拍照任务
function myWorkPhotoLocation(data) {
  return (0, _http.request)({
    method: 'GET',
    url: _api.MYWORKPHOTO_LOCATION,
    showSuccessToast: true,
    data: data });

}
//提交拍照任务
function photoSubmit(data) {
  return (0, _http.request)({
    method: 'POST',
    url: _api.PHOTO_SUMBIT,
    showSuccessToast: true,
    data: data });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.loanAppt = loanAppt;exports.loanList = loanList;exports.loanListDetail = loanListDetail;exports.loanBank = loanBank;exports.loanFaceMember = loanFaceMember;exports.loanPeriod = loanPeriod;exports.faceSumbit = faceSumbit;var _http = __webpack_require__(/*! @/config/http.js */ 19);


var _api = __webpack_require__(/*! @/config/api.js */ 20);var _require =


__webpack_require__(/*! ./storage.js */ 146),getStorage = _require.getStorage;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _require = __webpack_require__(/*! ../utils/storage.js */ 17),getStorage = _require.getStorage;
/**
...
module.exports = {
  ...
  /** 首页 **/
  LOAD_HOME_CAROUSEL: "".concat(baseUrl, "/wx/user/loadPicture"),
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.loadActivity = loadActivity;exports.completeActivity = completeActivity;var _http = __webpack_require__(/*! @/config/http.js */ 19);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.loadCustomer = loadCustomer;var _http = __webpack_require__(/*! @/config/http.js */ 19);
...
module.exports = {
  ...
  // 专属海报
  POSTER_1: "".concat(staticUrl, "/todoChild/poster/1.jpg"),
  POSTER_2: "".concat(staticUrl, "/todoChild/poster/2.jpg"),
  ...
  // 约量房
  LOAN_PICTURE: "".concat(staticUrl, "/todoChild/\u88C5\u4FEE\u5206\u671F\u4ED8\uFF0C\u8F7B\u677E\u5C31\u5165\u4F4F.png"),
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.loadHomeCarousel = loadHomeCarousel;var _http = __webpack_require__(/*! @/config/http.js */ 19);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.loadCity = loadCity;var _http = __webpack_require__(/*! @/config/http.js */ 19);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.IWX = exports.renum = exports.Result = void 0;var _wx = __webpack_require__(/*! @/api/wx.js */ 633);function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}
...
var stringUtil = {
  ...
  /**
                    * 给字符串分段
                    */
  stringSegment: function stringSegment(content, segmentLength) {
    var stringArr = [];
    var tempStr = '';
  ...
  /**
      ...
      * 往字符串前面添加 0
      */
  add0InFront: function add0InFront(value, n) {
    value = value.toString();
    if (value.length < n) {
      var addNum = n - value.length;
  ...
  /**
      * 62进制转换为字符
      */
  toCharBy62: function toCharBy62(code) {
    code = parseInt(code);
    if (code >= 0 && code <= 9)
    ...
    if (code >= 36 && code <= 62)
    return String.fromCharCode(code + 29);else
  ...
  /**
      * 解析字符串
      */
  compression: function compression(str) {
    var equalSign = "%3D";
    var comma = "%26";
    var id = str.substring(str.indexOf(equalSign) + equalSign.length, str.indexOf(comma));
    var referrerId = str.substring(str.indexOf(equalSign) + equalSign.length);
  ...
  /**
      * 该字符串是否包含另一个字符串
      */
  isContain: function isContain(contain, beContain) {
...
Result = /*#__PURE__*/function () {
  function Result(code, msg, data) {_classCallCheck(this, Result);
    this.code = code;
    this.msg = msg;
    this.data = data;
  }_createClass(Result, [{ key: "setData", value: function setData(

    data) {
      this.data = data;
      return this;
    } }]);return Result;}();exports.Result = Result;
...
var IWX = {
  ...
  /**
             * wx方法 Promise包装
             */
  invoke: function invoke(methodName, objParam) {
    var asyn = new Promise(function (resolve, reject) {
      var param = {
        success: function success(res) {
  ...
  /**
      * 检测用户是否开启该权限
      */
  getIsPermission: function getIsPermission(permission) {
    var asyn = new Promise(function (resolve, reject) {
      wx.getSetting({
        success: function success(res) {
...
/**
                                                                              * 推广图 类
                                                                              */exports.IWX = IWX;var
ShareCanvas = /*#__PURE__*/function () {_createClass(ShareCanvas, null, [{ key: "getCanvasById",

    /**
                                                                                                  * 通过ID获取推广图
                                                                                                  */value: function getCanvasById(
    id) {
      return this;
    }
  ...
  {var ctx = _ref.ctx,imgUrl = _ref.imgUrl,qRCodeUrl = _ref.qRCodeUrl,title = _ref.title,price = _ref.price,_ref$width = _ref.width,width = _ref$width === void 0 ? 250 : _ref$width,_ref$height = _ref.height,height = _ref$height === void 0 ? 400 : _ref$height,_ref$qRCodeWidth = _ref.qRCodeWidth,qRCodeWidth = _ref$qRCodeWidth === void 0 ? 280 : _ref$qRCodeWidth;_classCallCheck(this, ShareCanvas);
    // 画布对象
    this.ctx = ctx,
  ...
  /**
     * 获取设备高宽
     */_createClass(ShareCanvas, [{ key: "getSystemWidthHeight", value: function getSystemWidthHeight()
    {
      IWX.invoke("getSystemInfo").then(function (result) {
        console.log(result);
      });
    }
    ...
    {var _this = this;
      return new Promise(function (resolve, reject) {
        var p1 = _this.checkPermission().then(function (result) {// 如果用户曾经拒绝了授权，就需要跳转设置授权页面
          if (result.code == renum.UNAUTHORIZED)
          reject(result);
        });
        p1.then(function () {
          var p2 = _this.drawImg();
          var p3 = _this.drawLittleProgramCode().then(function (result) {
            _this.drawCodeDesc();
          });
          _this.fillBackgroundColor();
          _this.drawRet();
          var titleArr = stringUtil.stringSegment(_this.title, _this.segmentLength);
          _this.drawTextArr(_this.pruneTitleArr(titleArr));
    ...
    /**
       * 检测是否有保存图片到本地的权限
       */ }, { key: "checkPermission", value: function checkPermission()
    {
      return new Promise(function (resolve, reject) {
        IWX.getIsPermission("scope.writePhotosAlbum").then(function (result) {
    ...
    /**
       * 填充画布底色
       */ }, { key: "fillBackgroundColor", value: function fillBackgroundColor()
    {
    ...
    /**
       * 绘制矩形边框
       */ }, { key: "drawRet", value: function drawRet()
    {
      this.ctx.setStrokeStyle(this.borderColor);
      var recWidth = this.width - 2 * this.borderWidth;
      var recHeight = this.height - this.borderBottom - this.borderWidth;
    ...
    /**
       * 绘制标题文本(数组)
       */ }, { key: "drawTextArr", value: function drawTextArr(
    textArr) {var _this2 = this;
      var recHeight = this.height - this.borderBottom - this.borderWidth; // 内边框高度
      var imgHeight = this.width - 2 * this.borderWidth; // 正中图片高度
      var alignSpacing = this.titleAlignSpacing(recHeight, imgHeight, textArr);
      this.ctx.setFontSize(this.titleSize);
      this.ctx.setFillStyle(this.titleColor);
      this.ctx.setTextAlign('center');
      textArr.forEach(function (item, index) {
        if (index == 2) {
          _this2.ctx.setFillStyle(_this2.priceColor);
        }
        _this2.ctx.fillText(item, _this2.width / 2, imgHeight + _this2.borderWidth + alignSpacing + _this2.titleSize);
        alignSpacing += parseInt(_this2.titleSize * 1.5);
      });
    }

    /**
       * 调整标题字体间距
       */ }, { key: "titleAlignSpacing", value: function titleAlignSpacing(
    recHeight, imgHeight, textArr) {
      var alignSpacing = parseInt((recHeight - imgHeight - this.titleSize * 1.5 * textArr.length) / 2); // 垂直间距
      var minAS = (recHeight - imgHeight) / 25; // 最小垂直间距
    ...
    /**
       * 绘制小程序码
       */ }, { key: "drawLittleProgramCode", value: function drawLittleProgramCode()
    {var _this3 = this;
      this.qRCodeWidth = this.borderBottom - 2 * this.borderWidth;
      return new Promise(function (resolve, reject) {
        console.log(_this3.qRCodeUrl);
        IWX.invoke("getImageInfo", {
          "src": _this3.qRCodeUrl }).
        then(function (result) {
          _this3.ctx.drawImage(result.data.path, _this3.borderWidth, _this3.height - _this3.borderBottom + _this3.borderWidth,
          _this3.qRCodeWidth, _this3.qRCodeWidth);
    ...
    /**
       ...
       */ }, { key: "pruneTitleArr", value: function pruneTitleArr(
    textArr) {
      var tempArr = [];
      if (textArr.length > 2) {
        tempArr[0] = textArr[0];
    ...
    /**
       * 下载图片到临时地址,并绘制图片
       */ }, { key: "drawImg", value: function drawImg()
    {var _this4 = this;
      return new Promise(function (resolve, reject) {
        var ctx = _this4.ctx;
        var p1 = _this4.borderWidth;
        var p2 = _this4.width - 2 * _this4.borderWidth;
        var url = _this4.urlConversion(_this4.imgUrl);
        IWX.invoke("getImageInfo", {
          "src": url }).
        then(function (result) {
    ...
    /**
       * 图片URL转换为可下载URL
       */ }, { key: "urlConversion", value: function urlConversion(
    url) {
      return url;
    ...
    /**
       ...
       * 检测有没有权限，有则保存图片
       * 否则，申请权限，然后保存图片
       */ }, { key: "saveImgLocal", value: function saveImgLocal(
    tempPath) {var _this5 = this;
      return new Promise(function (resolve, reject) {
        _this5.checkPermission().then(function (result) {
          if (result.code == renum.UNAUTHORIZED) {
            resolve(result);
          } else if (result.code == renum.NOPERMISSION) {
            _this5.applyAuthorization().then(function (result) {
    ...
    /**
       * 申请授权(图片保存到本地权限)
       */ }, { key: "applyAuthorization", value: function applyAuthorization()
    {
      return new Promise(function (resolve, reject) {
    ...
    /**
       * 绘制二维码说明文
       */ }, { key: "drawCodeDesc", value: function drawCodeDesc()
    {var _this6 = this;
      var codeDescArr = stringUtil.stringSegment(this.qRCodeDesc, 10);
      var alignSpacing = this.codeDescAlignSpacing(codeDescArr);
      var x = (this.width - 3 * this.borderWidth - this.qRCodeWidth) / 2 + this.borderWidth + this.qRCodeWidth;
      this.ctx.setFontSize(this.qRCodeDescSize);
      this.ctx.setFillStyle(this.qRCodeDescColor);
      this.ctx.setTextAlign('center');
      codeDescArr.forEach(function (item, index) {
        _this6.ctx.fillText(item, x, _this6.height - _this6.borderBottom + _this6.borderWidth + alignSpacing + _this6.qRCodeDescSize);
        alignSpacing += parseInt(_this6.qRCodeDescSize * 1.5);
      });
    }

    /**
       * 调整二维码说明文行间距
       */ }, { key: "codeDescAlignSpacing", value: function codeDescAlignSpacing(
    codeDescArr) {
      var alignSpacing = parseInt((this.borderBottom - this.borderWidth - this.qRCodeDescSize * 6 / 4 * codeDescArr.length) /
      2); // 标题到文字的垂直距离
      var minAS = this.borderBottom / 10;
      ...
      return alignSpacing;
    } }]);return ShareCanvas;}();exports.default = ShareCanvas;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));var _common = __webpack_require__(/*! @/config/common.js */ 16);


var _http = __webpack_require__(/*! @/config/http.js */ 19);


var _openLogin = __webpack_require__(/*! @/utils/openLogin.js */ 12);
